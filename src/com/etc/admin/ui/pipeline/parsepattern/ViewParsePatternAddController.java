...
public class ViewParsePatternAddController {
	...
	private void updateParsePattern(){

/*		PipelineParsePattern pattern = DataManager.i().mPipelineParsePattern;
		if (pattern != null) {
			DataManager.i().mAddPipelineParsePatternRequest = null;			
			DataManager.i().mAddPipelineParsePatternRequest = new AddPipelineParsePatternRequest();
			DataManager.i().mAddPipelineParsePatternRequest.setPipelineParsePattern(pattern);
		
			DataManager.i().mAddPipelineParsePatternRequest.setName(prseNameLabel.getText());
			DataManager.i().mAddPipelineParsePatternRequest.setDescription(prseDescriptionLabel.getText());
			DataManager.i().mAddPipelineParsePatternRequest.setExampleSource(prseExampleSourceLabel.getText());
			DataManager.i().mAddPipelineParsePatternRequest.setExampleResult(prseExampleResultLabel.getText());
			DataManager.i().mAddPipelineParsePatternRequest.setPattern(prsePatternLabel.getText());
		}
*/	}
	...
	private void onSave(ActionEvent event) {
		...
		//DataManager.i().saveDunamicFileSpecification();
